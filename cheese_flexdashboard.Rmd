...
<!--     vertical_layout: fill -->
<!--     navbar: -->
<!--       - { title: "Github Repo", href: "https://github.com/alinagalyon/Cheese-database", align: left } -->
<!-- theme: -->
<!--   version: 4 -->
<!--   bootswatch: minty -->
<!-- css: styles.css -->
...
# "#1f4f4f" "#2c7a7b" "#319795" "#2c7a7b" "#edf7f5" "#e6f4f1" "#cce7e1""#1f4f4f" "#2c7a7b"
```
