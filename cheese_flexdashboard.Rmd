...
Here are some charts about cheese. It's important to study cheese because it is interesting. It is interesting because we love cheese.
...
### Cheese Phylogeny {data-height="800"}

Build a flavor-by-animal heatmap ordered by an OpenTree phylogeny, with extra row annotations (avg fat, avg calcium) and tree tip labels, showing sample size:
